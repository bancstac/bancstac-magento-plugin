...
namespace Paycorp\Payments24\Model\Method;
...
{
    const METHOD_CODE = 'paycorp_cc24';
    ...
    protected $_infoBlockType = 'Paycorp\Payments24\Block\Info\Cc';
    ...
    {
        return $this->urlBuilder->getUrl('paycorp24/payment/index', ['_secure' => $this->request->isSecure()]);
    }
}
