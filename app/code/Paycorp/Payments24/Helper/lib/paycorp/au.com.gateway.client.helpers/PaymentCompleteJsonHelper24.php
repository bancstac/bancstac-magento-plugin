...
class PaymentCompleteJsonHelper24 {
    ...
    public function fromJson($responseData) {
        ...
        $paymentCompleteResponse = new PaymentCompleteResponse24();
        ...
        $transactionAmount = new TransactionAmount24();
