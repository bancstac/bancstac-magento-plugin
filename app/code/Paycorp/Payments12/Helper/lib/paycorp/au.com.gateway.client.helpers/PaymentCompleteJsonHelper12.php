...
class PaymentCompleteJsonHelper12 {
    ...
    public function fromJson($responseData) {
        ...
        $paymentCompleteResponse = new PaymentCompleteResponse12();
        ...
        $transactionAmount = new TransactionAmount12();
