...
class PaymentCompleteResponse12 {
    ...
    private $tokenAuthResponseText;
    private $tokenAuthTxnReference;
    private $authCode;
    private $cvcResponse;
    private $extraData;
    ...
    public function getTokenAuthResponseText(){
        return $this->tokenAuthResponseText;
    }
    
    public function setTokenAuthResponseText($tokenAuthResponseText){
        $this->tokenAuthResponseText = $tokenAuthResponseText;
    }
    
    public function getTokenAuthTxnReference(){
        return $this->tokenAuthTxnReference;
    }
    
    public function setTokenAuthTxnReference($tokenAuthTxnReference){
