...
namespace Paycorp\Payments12\Controller\Payment;
...
class Index extends Action
{
    ...
    /**
     * @var \Paycorp\Payments12\Helper\Data
     */
    protected $helper;
     ...
     * @param \Paycorp\Payments12\Helper\Data               $helper
    ...
    public function __construct(
        ...
        \Paycorp\Payments12\Helper\Data $helper,
    ...
    public function execute()
    {
        try {
            ...
            $clientConfig = new \ClientConfig12();
            ...
            $client = new \GatewayClient12($clientConfig);
            $initRequest = new \PaymentInitRequest12();
            ...
            $transactionAmount = new \TransactionAmount12(intval($amount * 100));
            ...
            $redirect = new \Redirect12();
            $redirect->setReturnUrl($this->urlBuilder->getUrl('paycorp12/payment/success', [
