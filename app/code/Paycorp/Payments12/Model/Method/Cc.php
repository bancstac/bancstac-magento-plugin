...
namespace Paycorp\Payments12\Model\Method;
...
{
    const METHOD_CODE = 'paycorp_cc12';
    ...
    protected $_infoBlockType = 'Paycorp\Payments12\Block\Info\Cc';
    ...
    {
        return $this->urlBuilder->getUrl('paycorp12/payment/index', ['_secure' => $this->request->isSecure()]);
    }
}
